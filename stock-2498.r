...
h=getSymbols("2498.TW",auto.assign=FALSE) #下載股市資料 getSymbols並定義一個字母h 以htc為例子
h	#抓取2498資料
...
position<-Lag(ifelse(ma_20>ma_60, 1,-1))	#解說：position為一個時間序列，以日為單位，如果20ma大於60ma，設值為1；否則設值為0空手,-1做空。由於我們是日資料，訊號發生時只能隔天做交易，故將這向量全部往後遞延一天。
